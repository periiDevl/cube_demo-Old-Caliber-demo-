...
void SimpleCollisionX(float x1, float x2, float z1, float z2, glm::vec3 Position);
void SimpleCollisionZ(float x1, float x2, float z1, float z2, glm::vec3 Position);
